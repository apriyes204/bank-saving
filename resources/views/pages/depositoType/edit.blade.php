...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            Merubah Data Type Deposito {{$depositoType->name}}
        </h1>
            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <form action="{{route('deposito-type.update', $depositoType->id)}}" method="post">
                            @method('PUT')
                            @csrf
                            <div class="mb-3">
                                <label for="inputName" class="form-label">Name Type Deposito</label>
                                <input type="text" class="form-control" name="name" id="inputName"
                                    value="{{old('name', $depositoType->name)}}" id="inputName" aria-describedby="nameHelp"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" step="0.01" name="return" id="inputReturn"
                                    value="{{old('return', $depositoType->return)}}" id="inputReturn" aria-describedby="returnHelp"
                                    placeholder="Return Yearly (%)">
                            </div>
