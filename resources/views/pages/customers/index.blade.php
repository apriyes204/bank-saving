...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{route('customers.create')}}" class="d-none d-sm-inline-block btn btn-primary shadow-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{route('customers.edit', $item->id)}}" title="Edit"
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-center">
                                    ...
                                    <li class="page-item"><a class="page-link"
                                            href="{{ $customers->previousPageUrl() }}" rel="prev">Previous</a></li>
                                    @endif
                                    ...
                                    <li class="page-item"><a class="page-link" href="{{ $customers->nextPageUrl() }}"
                                            rel="next">Next</a></li>
                                    @else
